          ...
          <div className="flex gap-4">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full h-10 rounded-lg border border-gray-200 dark:border-gray-600 cursor-pointer p-0.5 bg-white/80 dark:bg-gray-700/80"
              />
            </div>
            <div className="flex-1">
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:border-blue-400 transition-all"
              >
                <option value="debit" className="bg-white dark:bg-gray-800">Debit (expense)</option>
                <option value="credit" className="bg-white dark:bg-gray-800">Credit (income)</option>
              </select>
            </div>
          </div>
